	...
	<div class="main_menu">
		<ul>
			...
			<li><a href="#">NỘI THẤT VĂN PHÒNG</a>
				<ul>
					<li><a href="#">BÀN GHẾ VĂN PHÒNG</li>
					<li><a href="#">TỦ TÀI LIỆU</li>
					<li><a href="#">QUẦY THU NGÂN</li>
					<li><a href="#">VÁCH NGĂN</li>
				</ul>
			</li>
			<li><a href="#">ĐỒ GỖ TRANG TRÍ</a>
				<UL>
					<li><a href="#">TRANH GỖ</li>
					<li><a href="#">BÀN GHẾ GỐC CÂY</li>
					<li><a href="#">TƯỢNG GỖ</li>
				</UL>
			</li>
			<li><a href="#">ĐẶT HÀNG</li>
