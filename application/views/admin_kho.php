...
<div class="menu-right">
	<div>
		...
		<div class="row" style="background: #ccc;margin: 20px 0 20px 0; ">
  			<div class="btn-group" role="group" aria-label="..." style="float: left; margin: 20px;">
				...
				<a href="<?php echo base_url()?>Admin_kho/nhapkhomoi" class="btn btn-info lien-he login-window button orange">
    ...
    <?php 
      ...
      <tr>
        ...
        <td><?php echo $key->Baohanh?></td>
        <td><a href="<?php echo base_url()?>Admin_kho/nhapkhocu/<?php echo $key->kho_id?>">Nhập kho</a>
        </td>
      </tr>
      <?php }}?>
    </tbody>
