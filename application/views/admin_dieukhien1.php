		...
		<div class="col-lg-12">
			...
			<div class="col-lg-8">
				<div class="rows" style="margin-top: 50px;">
					<a href="<?php echo base_url()?>Dieukhien" style="border: 1px #c8c0c0 solid; width: 30px; height: 20px; padding: 10px; background: #a39baa4d; color: black;">Bán chạy nhất</a>
					<a href="<?php echo base_url()?>Dieukhien/dieukhien1" style="border: 1px #c8c0c0 solid; width: 30px; height: 20px; padding: 10px; background: #a39baa4d; color: black; border-top-width: 0.4rem; border-top-style: solid;border-top-color: orange  ;background: white;">Sản phẩm được xem nhiều nhất</a>
					...
					<table class="table">
						<thead>
							<thead>
								...
								<td style="font-weight: bold;">Số lượng xem</td>
							</thead>
							<?php 
								if(isset($product1))
								{
