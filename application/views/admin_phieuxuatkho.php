...
<div class="menu-right">
	<div>
		<div class="row">
			<div class="col-lg-5">
				<p style="font-size: 30px;font-weight: bold; padding: 0px 0 0 20px;">PHIẾU XUẤT KHO</p>
			</div>
			<div class="col-lg-7">
		...
		<div class="row" style="background: #ccc;margin: 20px 0 20px 0; ">
			...
			<div class="btn-group" role="group" aria-label="..." style="float: right; margin: 20px;height: 36px;">
    	...
    	<div style=" width: 90%;background-color: white; box-shadow: 5px 5px 15px #ccc; margin: 0 auto; padding: 0 20px 0 20px;">
    		<div >
    			<p style="text-align: center; font-weight: bold; font-size: 30px">PHIẾU XUẤT KHO</p><br/>
    			<?php if(isset($gettt1)){
    			...
    			<div><p>Tổng tiền: <?php echo $money;?></p>
    				...
    				<?php
			  				if(isset($gettt1)){
			  					foreach ($gettt1 as $key) { 
							?>
    				<a href="<?php echo base_url() ?>Admin_xuatkho/inphieu/<?php echo $key->Dondh_id?>" class="btn btn-default" style="float:right;">In phieu</a>
    				<?php }}?> 
    			</div>
    			<!-- <?php }}?> -->
    		</div>
