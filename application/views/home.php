  ...
  <div class="col-lg-9">
	  	...
	  	<div class="home-main row">
	  		<div class="home-taxonomi" style="-moz-border-radius-topleft:10px;
	  			...
	  			<a href="<?php echo base_url()?>danhmuc/view/<?php echo $key->danhmuc_id?>" style = "color:#67c62e; ">Mẫu <?php echo $key->tendanhmuc?> đẹp</a>
	  			</h3>
						...
						<div class="col-lg-4 cacho"><!-- chia làm 3 sp trên 1 dòng -->
		  						<div class = "sp-list" >
		  							<div class="sp-view"> 
				  						...
				  						<img style="margin: 0 auto; width: 275px; height: 157px;" src="<?php echo base_url()?>public/img/<?php echo $key->Anh_sp?>"></a>
				  					</div>
				  					<div style="">
					  					<p class="name"><a href="<?php echo base_url()?>product/view/<?php echo $key->sanpham_id?>" style="color: black;font-weight: bold;"><?php echo $key->Ten_sp." 0".$key->sanpham_id?></a></p>
