...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 20, 2017 lúc 08:14 CH
...
(53, '2017-06-13 18:49:30', 50000000, 'Nguyễn Đắc Huy', '0966599493', 'dac.huy.9x@gmail.com', 'Hà Nội', '', '0'),
(55, '2017-06-13 19:52:42', 25000000, 'Lại Thị Lan Anh', '0972940495', 'lananh@gmail.com', 'Nam Định', 'Chuyển về BigC Nam Định', '0'),
...
(59, '2017-06-19 16:23:54', 500000000, 'Lan Anh', '1452', 'lananh@gmail.com', 'Nam Định', 'hiển', '0');
...
(36, 'Bộ bàn ghế', 'banghe31.jpg', 0, 25000000, 0, 100, 100, '30x50x60', 'vàng', 'gụ', 'KBG', 2, '5 năm', 'Bộ bàn ghế gồm 2 ghế ngồi, 1 ghế dài và 1 bàn uốn nước', 1, 0),
...
(39, 'Bộ bàn ghế', 'banghe61.jpg', 0, 15000000, 0, 98, 98, '14x25x65', 'nâu', 'sưa', 'KBG', 2, '10 năm', 'Bộ bàn ghế gồm có 2 ghế đôn, 4 ghế ngồi và bàn uống nước', 102, 1),
(40, 'Sập', 'sapgu2.jpg', 0, 35000000, 0, 110, 110, '250x300x40', 'đỏ', 'hương', 'KSG', 1, '10 năm', '', 0, 0),
(41, 'Sập hương', 'goccay32.jpg', 55000000, 50000000, 500000000, 80, 90, '300x300x60', 'nâu', 'hương', 'KSG', 2, '7 năm', '<p>Sản phẩm \"Sập Hương cao cấp\", các đường nét trạm khắc đa phần được làm thủ công, bởi bàn tay tài hoa của các nghệ nhân nhiều năm trong nghề.</p>																																', 74, 22),
...
(44, 'Giường', 'giuong4.jpg', 0, 15000000, 0, 140, 140, '150x200x30', 'đỏ', 'hương', 'NG', 3, '5 năm', '', 0, 0),
...
(52, 'Tủ tài liệu', 'tutailieu2.jpg', 0, 50000000, 0, 52, 50, '200x60x180', 'trắng', 'gụ', 'VTL', 6, '3 năm', '', 0, 0),
...
(55, 'Tủ áo', 'tuao1.jpg', 0, 25000000, 0, 9, 0, '200x60x180', 'nâu', 'gụ', 'NTA', 3, '7 năm', '', 14, 1),
...
--
ALTER TABLE `chitietdondh`
  MODIFY `chitietdondh_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
-- AUTO_INCREMENT cho bảng `chitietnhapkho`
--
ALTER TABLE `chitietnhapkho`
  MODIFY `chitiet_nk_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `dondh`
  MODIFY `Dondh_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
--
...
--
ALTER TABLE `nhapkho`
  MODIFY `nhapkho_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT cho bảng `noidung`
--
ALTER TABLE `noidung`
  MODIFY `noidung_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `timkiem`
  MODIFY `id_timkiem` int(11) NOT NULL AUTO_INCREMENT;
--
